	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="card">
					<h5 class="card-header">Редактирование тем заявок</h5>
					<div class="card-body">
						<table class="table">
							<thead>
								<tr>
									<th scope="col" class="col-1" style="min-width: 100px;">#</th>
									<th scope="col" class="col-3" style="min-width: 200px;">Тема</th>
									<th scope="col">Описание</th>
								</tr>
							</thead>
							<tbody>
								<?php echo $tickets->get_themes_table(); ?>
							</tbody>
						</table>
						<button id="button-theme-add" type="button" class="btn btn-secondary">Добавить тему</button>
					</div>
				</div>
			</div>
		</div>
